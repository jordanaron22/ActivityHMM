...
for (file_ind in 1:length(file_list)){
  ...
  reset_true_array[,file_ind] <- params_to_save[[1]][[5]]
  reset_est_array[,file_ind] <- params_to_save[[2]][[5]]
  
  pil_true_array[,file_ind] <- params_to_save[[1]][[6]]
  pil_est_array[,file_ind] <- params_to_save[[2]][[6]]
...
AnalyzeResids(binom_true_array,binom_est_array,1,title = "Act LoD")

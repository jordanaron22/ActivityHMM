...
p = nested_loop_base_plot(
    plot_data,
    x_name = "", 
    y_name = "Percent Correctly Predicted",
    colors = viridis::viridis(11)[c(1,3:10)],
    legend_labels = c(0,1,2,3,4,5,6,7,8),
    connect_spus = T
)
...
plot_data = nested_loop_paramsteps_data(
    plot_data,
    steps_y_base = 0.7, steps_y_height = .025, steps_y_shift = .05
)
...
p + labs(color='Number of Support Points',title = "Total Accuracy by Model, Sample Size, and RE Distribution") +
  guides(size = F, shape = F, linetype = F)

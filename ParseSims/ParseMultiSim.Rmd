...
ParseSingleClust <- function(folder, path_size ){
  ...
  vit_array <- matrix(0,3,length(file_list))
...
colnames(vit_df)[1] <- "Wake/Sleep Accuracy"
...
plot_data = nested_loop_base_data(
    ...
    grid_cols = c("Wake/Sleep Accuracy"),
    spu_x_shift = 2,
...
p + labs(color='Number of Support Points',title = "Wake/Sleep/Total Accuracy by Model, Sample Size, and RE Distribution") + 
  guides(size = F, shape = F, linetype = F)

# ggsave("finalprojNL2.png",width = 9,height = 9)
```
...
# ggsave("finalprojNL3.png",width = 8,height = 8)
```

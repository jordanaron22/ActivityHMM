...
path_size <- "/Users/aronjr/Documents/Predoc/ActivityHMM/ParseSims/Sim/Mix1/Size3"
...
SimScatter <- function(SingleSim){
  ...
  nre.labs <- c(paste(c(2:8), "Support Points"))
  names(nre.labs) <- c(2:8)
  ...
  ggplot(final_df, aes(y=mix, x=act)) +
    ...
    ggtitle("MHMM Mixing Proportion by Wake Activity Cluster") + 
    theme_bw()
}
...
grid.arrange(SimBoxplot(SingleSim,1,2,2,T,"Initial Probability"),
             ...
             SimBoxplot(SingleSim,4,2,1,T,"Wake LoD"),
             SimBoxplot(SingleSim,4,2,2,T,"Sleep LoD"),
             ncol= 2)

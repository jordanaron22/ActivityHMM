...
path_size <- "/Users/aronjr/Documents/Predoc/ActivityHMM/ParseSims/Sim/Norm/Size1"
...
SimScatter <- function(SingleSim){
  ...
  ggplot(final_df, aes(y=mix, x=act)) +
    ...
    ggtitle("Mixing Proportion by Wake Cluster Mean for a MHMM with 1-8 Support Points") +
    theme_bw()
}
...
g <- arrangeGrob(SimBoxplot(SingleSim,1,2,2,T,"Initial Sleep Probability"),
             SimBoxplot(SingleSim,3,2,1,T,"Wake Activity SE",2),
             SimBoxplot(SingleSim,3,2,2,T,"Sleep Activity Mean",1),
             SimBoxplot(SingleSim,3,2,2,T,"Sleep Activity SE",2),
             SimBoxplot(SingleSim,4,2,1,T,"Wake Zero Inflated Probability"),
             SimBoxplot(SingleSim,4,2,2,T,"Sleep Zero Inflated Probability"),
             ncol= 2)

setwd("../Plots")
ggsave("MiscParamBox.png",width = 9,height = 9,g)



SimScatter(SingleSim)
setwd("../Plots")
ggsave("clustmeanmix.png",width = 9,height = 9)
